...
from utils import plot_word_correlation_gender, plot_word_correlation_religion, plot_word_correlation_scm
...
def get_args():
    ...
    parser.add_argument("--bias", default="gender", type=str, choices=["gender", "religion", "warmth", "competence", "scm"], help="Bias type.")
...
def main():
    ...
    for l in layers:
        ...
        elif args.bias in ['scm', 'warmth', 'competence']: 
            ppl = 30
            plot_word_correlation_scm(args.output_dir, args.bias, layers=l, perplexity=ppl, result_filename=f'{args.bias}_ppl{ppl}')
