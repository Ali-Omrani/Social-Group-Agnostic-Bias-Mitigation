...
def split_data(attributes_examples, attributes_labels, neutral_examples, neutral_labels, args):
    ...
    for i, (examples, labels) in enumerate(zip(attributes_examples, attributes_labels)):
        ...
        if args.algorithm == 'ADEPT' or args.algorithm == 'ADEPT-finetuning' or args.algorithm == "ADEPT-DPCEloss":
            data['train']['example'][f'attribute{i}'] = examples[args.dev_data_size:]
            data['train']['label'][f'attribute{i}'] = labels[args.dev_data_size:]
        else:
            data['train']['example'][f'attribute{i}'] = examples[args.dev_data_size: args.dev_data_size+args.train_data_size]
            data['train']['label'][f'attribute{i}'] = labels[args.dev_data_size: args.dev_data_size+args.train_data_size]
    ...
    if args.algorithm == 'ADEPT' or args.algorithm == 'ADEPT-finetuning' or args.algorithm == "ADEPT-DPCEloss":
        ...
        data['train']['example']['neutral'] = neutral_examples[args.dev_data_size: args.dev_data_size+args.train_data_size]
    ...
    if neutral_labels is not None:
        ...
        if args.algorithm == 'ADEPT' or args.algorithm == 'ADEPT-finetuning' or args.algorithm == "ADEPT-DPCEloss":
            ...
            data['train']['label']['neutral'] = neutral_labels[args.dev_data_size: args.dev_data_size+args.train_data_size]
