...
class DataTrainingArguments:
    ...
    #     default=1,
    #     metadata={
    #         "help": "The number of steps to accumulate eval results before passing back to cpu"
    #     },
    # )
...
def main():
    ...
    if model_args.model=="BertPrefixForSequenceClassification" and config.num_labels!=2: 
